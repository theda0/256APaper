...
Near the end, we will look at one possibility in \thref{RiemannExistence}, which relates the two in the case of finite type schemes over $\C$.\\
...
We will first develop the notion of a profinite group, and extend our knowledge of Galois theory for finite extensions to the possibly infinite case.
